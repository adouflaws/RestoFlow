    ...
    <>
      <style>{`
        *{box-sizing:border-box;}html{scroll-behavior:smooth;}body{margin:0;}
        ...
        @keyframes rfPulse{0%,100%{box-shadow:0 0 0 0 rgba(22,163,74,.5);}70%{box-shadow:0 0 0 12px rgba(22,163,74,0);}}
        ...
        input[type=range]::-webkit-slider-thumb{-webkit-appearance:none;width:22px;height:22px;border-radius:50%;background:#1a4d2e;cursor:pointer;box-shadow:0 2px 8px rgba(26,77,46,.35);}
        input[type=range]::-moz-range-thumb{width:22px;height:22px;border-radius:50%;background:#1a4d2e;cursor:pointer;border:none;}
      ...
      <div style={{ fontFamily: "system-ui,-apple-system,sans-serif", color: "#0f172a", backgroundColor: "#fff", overflowX: "hidden" }}>
        ...
        <div style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 300, backgroundColor: RD, height: 44, display: "flex", alignItems: "center", justifyContent: "center", gap: 14, padding: "0 16px" }}>
          <p className="rf-urg-txt urg-blink" style={{ margin: 0, fontSize: 12.5, fontWeight: 700, color: "#fff", whiteSpace: "nowrap" as const }}>
            ...
            <strong style={{ borderBottom: "1px dashed rgba(255,255,255,.7)" }}>{spots} places</strong> au tarif actuel
          </p>
          <Link href="/signup" style={{ flexShrink: 0, fontSize: 11.5, fontWeight: 800, color: RD, backgroundColor: "#fff", borderRadius: 6, padding: "4px 11px", textDecoration: "none", whiteSpace: "nowrap" as const }}
        ...
        {/* ══════════════════════════════════════════════════════════════
            2. NAVBAR
        ══════════════════════════════════════════════════════════════ */}
        <nav style={{ position: "fixed", top: 44, left: 0, right: 0, zIndex: 200, backgroundColor: "rgba(255,255,255,.97)", backdropFilter: "blur(8px)", borderBottom: "1px solid #e2e8f0", boxShadow: "0 2px 12px rgba(0,0,0,.05)" }}>
          <div style={{ maxWidth: 1120, margin: "0 auto", padding: "0 28px", height: 64, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            <Link href="/" style={{ textDecoration: "none", display: "flex", alignItems: "center", gap: 10 }}>
              <div style={{ width: 34, height: 34, borderRadius: 9, backgroundColor: G, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12, fontWeight: 900, color: "#fff" }}>RF</div>
              <span style={{ fontSize: 17, fontWeight: 800, color: "#0f172a", letterSpacing: "-.4px" }}>RestoFlow</span>
            </Link>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <span style={{ fontSize: 12, fontWeight: 700, color: GL, backgroundColor: "#f0fdf4", border: "1px solid #bbf7d0", borderRadius: 20, padding: "4px 12px", whiteSpace: "nowrap" as const }}>✦ 14 jours gratuits</span>
              <Link href="/signup" className="rf-pulse" style={{ fontSize: 13, fontWeight: 700, color: "#fff", padding: "8px 18px", borderRadius: 8, backgroundColor: G, textDecoration: "none", whiteSpace: "nowrap" as const, transition: "background .15s" }}
        ...
        {/* ══════════════════════════════════════════════════════════════
            3. HERO
        ══════════════════════════════════════════════════════════════ */}
        <section style={{ paddingTop: 44 + 64 + 64, paddingBottom: 88, paddingLeft: 28, paddingRight: 28, background: "linear-gradient(155deg,#f0fdf4 0%,#fff 58%)" }}>
          <div style={{ maxWidth: 1120, margin: "0 auto" }}>
            <div className="rf-hero" style={{ display: "flex", alignItems: "center", gap: 60 }}>

              {/* Gauche */}
              <div style={{ flex: "0 0 54%", maxWidth: 600 }}>
                <div className="rff" style={{ display: "inline-flex", alignItems: "center", gap: 7, backgroundColor: "#fef2f2", border: "1px solid #fecaca", borderRadius: 20, padding: "5px 14px", marginBottom: 22 }}>
                  <span>⚡</span>
                  <span style={{ fontSize: 12.5, fontWeight: 700, color: RD }}>Plus de 12 restaurants sur liste d&apos;attente</span>
                </div>

                <h1 className="rff d1 rf-h1" style={{ fontSize: 50, fontWeight: 900, lineHeight: 1.07, letterSpacing: "-1.8px", color: "#0f172a", margin: "0 0 22px" }}>
                  Votre restaurant <span style={{ color: RD }}>perd des commandes</span> chaque nuit pendant que vous dormez
                </h1>

                <p className="rff d2" style={{ fontSize: 17.5, color: "#64748b", lineHeight: 1.65, margin: "0 0 30px" }}>
                  RestoFlow transforme votre WhatsApp en assistant IA qui répond, prend les commandes et encaisse — 24h/24, 7j/7.{" "}
                  <strong style={{ color: "#0f172a" }}>Même à 3h du matin.</strong>
                </p>

                {/* Stats choc */}
                <div className="rff d2 rf-stats" style={{ display: "flex", backgroundColor: "#0f172a", borderRadius: 12, overflow: "hidden", marginBottom: 32 }}>
                  {[
                    ...
                    <div key={i} style={{ flex: 1, padding: "18px 14px", textAlign: "center" as const, borderRight: i < 2 ? "1px solid rgba(255,255,255,.08)" : "none" }}>
                      <div style={{ fontSize: 28, fontWeight: 900, color: "#fff", letterSpacing: "-1px", marginBottom: 4 }}>{s.num}</div>
                ...
                <div className="rff rf-hero-btns d3" style={{ display: "flex", gap: 12, flexWrap: "wrap" as const }}>
                  <Link href="/signup" style={{ display: "inline-flex", flexDirection: "column" as const, alignItems: "center", backgroundColor: G, color: "#fff", padding: "15px 30px", borderRadius: 10, fontSize: 15.5, fontWeight: 800, textDecoration: "none", boxShadow: "0 6px 24px rgba(26,77,46,.35)", transition: "all .15s", gap: 2 }}
                  ...
                  <a href="#features" style={{ display: "inline-flex", alignItems: "center", gap: 6, color: G, padding: "15px 22px", borderRadius: 10, fontSize: 15, fontWeight: 600, textDecoration: "none", border: `1.5px solid ${G}`, transition: "background .15s" }}
              ...
              <div className="rf-wa" style={{ flex: 1, display: "flex", justifyContent: "center" }}>
                <div style={{ width: 318, borderRadius: 22, overflow: "hidden", boxShadow: "0 28px 80px rgba(0,0,0,.18)", border: "1px solid rgba(0,0,0,.05)" }}>
                      ...
                      return (
                        <div key={i} className="chat-b" style={{ display: "flex", justifyContent: isC ? "flex-end" : "flex-start" }}>
                          <div style={{ maxWidth: "84%", padding: "7px 10px", borderRadius: isC ? "12px 2px 12px 12px" : "2px 12px 12px 12px", backgroundColor: isC ? "#dcf8c6" : "#fff", fontSize: 12, lineHeight: 1.5, color: "#111", boxShadow: "0 1px 2px rgba(0,0,0,.08)", whiteSpace: "pre-line" as const }}>
                            {msg.text}
                            <div style={{ fontSize: 9.5, color: "#94a3b8", textAlign: "right" as const, marginTop: 3 }}>{msg.time} {isC ? "" : "✓✓"}</div>
                          </div>
                        </div>
                      );
                    })}
                  </div>
                  <div style={{ backgroundColor: "#f0fdf4", padding: "8px 12px", display: "flex", alignItems: "center", gap: 7, borderTop: "1px solid #e2e8f0" }}>
        ...
        ══════════════════════════════════════════════════════════════ */}
        <section className="rf-sec" style={{ padding: "80px 28px", backgroundColor: "#f8fafc" }}>
          <div style={{ maxWidth: 1120, margin: "0 auto" }}>
            <div className="rff" style={{ textAlign: "center" as const, marginBottom: 44 }}>
              <h2 style={{ fontSize: 36, fontWeight: 900, letterSpacing: "-1px", color: "#0f172a", margin: 0 }}>
                La réalité des restaurants à Bamako
              </h2>
            </div>
            <div className="rf-ps" style={{ display: "flex", gap: 20 }}>
              <div className="rff d1" style={{ flex: 1, backgroundColor: "#fef2f2", border: "1px solid #fecaca", borderRadius: 16, padding: "32px 28px" }}>
                <div style={{ fontSize: 15, fontWeight: 800, color: RD, marginBottom: 22 }}>😓 SANS RestoFlow</div>
                {["Clients sans réponse la nuit","Commandes perdues pendant le service","Erreurs de commande manuelles","Paiements oubliés ou non encaissés","2-3h par jour à répondre aux messages"].map((item, i) => (
                  <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 10, marginBottom: 14 }}>
                    <span style={{ color: RD, fontWeight: 900, fontSize: 15, flexShrink: 0, marginTop: 1 }}>✗</span>
                    <span style={{ fontSize: 14.5, color: "#7f1d1d", lineHeight: 1.5 }}>{item}</span>
                  </div>
                ))}
              </div>
              <div className="rff d2" style={{ flex: 1, backgroundColor: "#f0fdf4", border: "1px solid #bbf7d0", borderRadius: 16, padding: "32px 28px" }}>
                <div style={{ fontSize: 15, fontWeight: 800, color: G, marginBottom: 22 }}>🚀 AVEC RestoFlow</div>
                {["Bot répond en 2 secondes, 24h/24","Zéro commande perdue","Commandes extraites automatiquement","Paiement Orange Money/Wave automatique","Vous gérez, le bot travaille"].map((item, i) => (
                  <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 10, marginBottom: 14 }}>
                    <span style={{ color: GL, fontWeight: 900, fontSize: 15, flexShrink: 0, marginTop: 1 }}>✓</span>
                    <span style={{ fontSize: 14.5, color: "#14532d", lineHeight: 1.5 }}>{item}</span>
                  </div>
                ))}
              </div>
            </div>
        ...
        <section id="testimonials" className="rf-sec" style={{ padding: "96px 28px" }}>
          <div style={{ maxWidth: 1120, margin: "0 auto" }}>
            <div className="rff" style={{ textAlign: "center" as const, marginBottom: 52 }}>
              <span style={{ fontSize: 11.5, fontWeight: 700, color: GL, letterSpacing: ".1em", textTransform: "uppercase" as const }}>Preuve sociale</span>
              <h2 style={{ fontSize: 36, fontWeight: 900, letterSpacing: "-1px", margin: "10px 0 0", color: "#0f172a" }}>
                Ce que disent les restaurants qui utilisent RestoFlow
              </h2>
            </div>
            <div className="rf-testi" style={{ display: "flex", gap: 20 }}>
              {TESTIMONIALS.map((t, i) => (
                <div key={i} className={`rff d${i + 1}`} style={{ flex: 1, backgroundColor: "#fff", border: "1px solid #e2e8f0", borderRadius: 16, padding: "28px 24px", display: "flex", flexDirection: "column" as const, gap: 14 }}>
                  <div style={{ fontSize: 16 }}>⭐⭐⭐⭐⭐</div>
                  <p style={{ fontSize: 14.5, color: "#374151", lineHeight: 1.72, margin: 0, fontStyle: "italic" as const, flex: 1 }}>
                    &ldquo;{t.text}&rdquo;
                  </p>
                  <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                    <div style={{ width: 42, height: 42, borderRadius: "50%", backgroundColor: t.color, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 14, fontWeight: 800, color: "#fff", flexShrink: 0 }}>{t.initials}</div>
                    <div>
                      <div style={{ fontSize: 14, fontWeight: 700, color: "#0f172a" }}>{t.name}</div>
                      <div style={{ fontSize: 12, color: "#94a3b8" }}>{t.resto}</div>
                    </div>
                  </div>
                </div>
              ))}
        ...
        {/* ══════════════════════════════════════════════════════════════
            6. FONCTIONNALITÉS
        ══════════════════════════════════════════════════════════════ */}
        <section id="features" className="rf-sec" style={{ padding: "80px 28px", backgroundColor: "#f8fafc" }}>
          <div style={{ maxWidth: 1120, margin: "0 auto" }}>
            <div className="rff" style={{ textAlign: "center" as const, marginBottom: 52 }}>
              <span style={{ fontSize: 11.5, fontWeight: 700, color: GL, letterSpacing: ".1em", textTransform: "uppercase" as const }}>Fonctionnalités</span>
              <h2 style={{ fontSize: 36, fontWeight: 900, letterSpacing: "-1px", margin: "10px 0 12px", color: "#0f172a" }}>
            ...
            <div className="rf-feat" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 18 }}>
              {FEATURES.map((f, i) => (
                <div key={i} className={`rff d${i + 1}`}
                  style={{ backgroundColor: "#fff", border: "1px solid #e2e8f0", borderRadius: 14, padding: "26px 22px", transition: "all .2s", cursor: "default" }}
                  onMouseEnter={(e) => { e.currentTarget.style.boxShadow = "0 8px 32px rgba(26,77,46,.1)"; e.currentTarget.style.borderColor = "#bbf7d0"; e.currentTarget.style.transform = "translateY(-3px)"; }}
                ...
                >
                  ...
                  <p style={{ fontSize: 13.5, color: "#64748b", margin: "0 0 14px", lineHeight: 1.6 }}>{f.desc}</p>
                  <span style={{ display: "inline-flex", alignItems: "center", gap: 5, backgroundColor: "#f0fdf4", border: "1px solid #bbf7d0", borderRadius: 20, padding: "3px 10px", fontSize: 11.5, fontWeight: 700, color: G }}>
                    ▲ {f.roi}
                  </span>
                </div>
              ))}
        ...
        <section id="pricing" className="rf-sec" style={{ padding: "96px 28px" }}>
          <div style={{ maxWidth: 1120, margin: "0 auto" }}>
            <div className="rff" style={{ textAlign: "center" as const, marginBottom: 48 }}>
              ...
              <p style={{ fontSize: 16, color: "#64748b", margin: "0 auto 20px", maxWidth: 560 }}>
                Un employé coûte 50 000 FCFA/mois et fait des erreurs. RestoFlow travaille 24h/24 sans jamais se tromper.
              </p>
              <div style={{ display: "inline-flex", alignItems: "center", gap: 8, backgroundColor: "#fef2f2", border: "1px solid #fecaca", borderRadius: 8, padding: "8px 16px" }}>
                <span>⚠️</span>
            ...
            <div className="rf-plans" style={{ display: "flex", gap: 20, alignItems: "stretch" }}>
              {PLANS.map((plan, i) => (
                <div key={i} className={`rff d${i + 1}`} style={{
                  flex: 1, borderRadius: 16, padding: "32px 26px",
                  border: plan.popular ? `2px solid ${G}` : "1.5px solid #e2e8f0",
                  backgroundColor: plan.popular ? "#f0fdf4" : "#fff",
                  position: "relative" as const, display: "flex", flexDirection: "column" as const,
                  boxShadow: plan.popular ? "0 16px 48px rgba(26,77,46,.15)" : "none",
                  ...
                  <h3 style={{ fontSize: 21, fontWeight: 800, color: "#0f172a", margin: "0 0 4px" }}>{plan.name}</h3>
                  <p style={{ fontSize: 12.5, color: "#94a3b8", margin: "0 0 18px" }}>{plan.desc}</p>
                  <div style={{ marginBottom: 24 }}>
                    <span style={{ fontSize: 38, fontWeight: 900, color: G, letterSpacing: "-1.5px" }}>{plan.price}</span>
                    <span style={{ fontSize: 13, color: "#94a3b8", marginLeft: 5 }}>FCFA / mois</span>
                  </div>
                  <ul style={{ listStyle: "none", padding: 0, margin: "0 0 24px", flex: 1, display: "flex", flexDirection: "column" as const, gap: 9 }}>
                    {plan.features.map((feat, j) => (
                      <li key={j} style={{ display: "flex", alignItems: "flex-start", gap: 8, fontSize: 13.5, color: feat.ok ? "#374151" : "#d1d5db" }}>
                        <span style={{ color: feat.ok ? GL : "#e2e8f0", fontWeight: 900, flexShrink: 0, marginTop: 1 }}>{feat.ok ? "✓" : "✗"}</span>
                        {feat.text}
                      </li>
                    ))}
                  </ul>
                  {plan.href.startsWith("http") ? (
                    <a href={plan.href} target="_blank" rel="noopener noreferrer"
                      style={{ display: "block", textAlign: "center" as const, padding: "13px 0", backgroundColor: "transparent", color: G, border: `1.5px solid ${G}`, borderRadius: 10, fontSize: 14, fontWeight: 700, textDecoration: "none", transition: "all .15s" }}
                    ...
                    <Link href={plan.href}
                      style={{ display: "block", textAlign: "center" as const, padding: "13px 0", backgroundColor: plan.popular ? G : "transparent", color: plan.popular ? "#fff" : G, border: `1.5px solid ${G}`, borderRadius: 10, fontSize: 14, fontWeight: 700, textDecoration: "none", transition: "all .15s" }}
            ...
            <div className="rff" style={{ textAlign: "center" as const, marginTop: 36, fontSize: 13.5, color: "#64748b" }}>
        ...
        <section className="rf-sec" style={{ padding: "80px 28px", backgroundColor: "#f8fafc" }}>
          <div style={{ maxWidth: 1120, margin: "0 auto" }}>
            <div className="rff" style={{ textAlign: "center" as const, marginBottom: 52 }}>
              <span style={{ fontSize: 11.5, fontWeight: 700, color: GL, letterSpacing: ".1em", textTransform: "uppercase" as const }}>ROI</span>
              <h2 style={{ fontSize: 36, fontWeight: 900, letterSpacing: "-1px", margin: "10px 0", color: "#0f172a" }}>
                Calculez votre retour sur investissement
              </h2>
            </div>
            <div className="rf-roi" style={{ display: "flex", gap: 24, alignItems: "flex-start" }}>
              {/* Sliders */}
              <div className="rff d1" style={{ flex: 1, backgroundColor: "#fff", border: "1px solid #e2e8f0", borderRadius: 16, padding: "32px 28px" }}>
                <div style={{ marginBottom: 34 }}>
                  <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 12 }}>
                    <label style={{ fontSize: 14, fontWeight: 600, color: "#0f172a" }}>Commandes par jour</label>
                    <span style={{ fontSize: 18, fontWeight: 900, color: G }}>{cmdPerDay}</span>
                  </div>
                  <input type="range" min={5} max={100} value={cmdPerDay} onChange={(e) => setCmdPerDay(Number(e.target.value))} />
                  <div style={{ display: "flex", justifyContent: "space-between", fontSize: 11, color: "#94a3b8", marginTop: 5 }}><span>5</span><span>100</span></div>
                </div>
                <div>
                  <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 12 }}>
                    <label style={{ fontSize: 14, fontWeight: 600, color: "#0f172a" }}>Prix moyen d&apos;une commande</label>
                    <span style={{ fontSize: 18, fontWeight: 900, color: G }}>{fmt(avgPrice)} FCFA</span>
                  </div>
                  <input type="range" min={1000} max={10000} step={500} value={avgPrice} onChange={(e) => setAvgPrice(Number(e.target.value))} />
                  <div style={{ display: "flex", justifyContent: "space-between", fontSize: 11, color: "#94a3b8", marginTop: 5 }}><span>1 000</span><span>10 000 FCFA</span></div>
                </div>
              </div>

              {/* Résultats */}
              <div className="rff d2" style={{ flex: 1, backgroundColor: "#fff", border: "1px solid #e2e8f0", borderRadius: 16, padding: "32px 28px" }}>
                <div style={{ marginBottom: 24 }}>
                  {[
                    { label: "CA mensuel actuel estimé", value: `${fmt(caActuel)} FCFA`, color: "#64748b" },
                    { label: "CA avec RestoFlow (+30%)",  value: `${fmt(caAvec)} FCFA`,   color: G },
                    { label: "Gain mensuel",             value: `+${fmt(gain)} FCFA`,    color: GL },
                    { label: "Coût RestoFlow Pro",       value: `-45 000 FCFA`,          color: "#ef4444" },
                  ].map((row, i) => (
                ...
                <div style={{ backgroundColor: benefice > 0 ? "#f0fdf4" : "#fef2f2", border: `2px solid ${benefice > 0 ? G : RD}`, borderRadius: 12, padding: "22px 20px", textAlign: "center" as const }}>
                  <div style={{ fontSize: 12, fontWeight: 600, color: benefice > 0 ? G : RD, marginBottom: 6, textTransform: "uppercase" as const, letterSpacing: ".05em" }}>Bénéfice net mensuel</div>
                  <div style={{ fontSize: 40, fontWeight: 900, color: benefice > 0 ? G : RD, letterSpacing: "-2px" }}>
        ...
        <section id="faq" className="rf-sec" style={{ padding: "80px 28px" }}>
          <div style={{ maxWidth: 720, margin: "0 auto" }}>
            ...
            {FAQS.map((faq, i) => (
              <div key={i} className={`rff d${Math.min(i + 1, 6)}`} style={{ borderBottom: "1px solid #e2e8f0" }}>
                ...
                >
                  ...
                  <span style={{ fontSize: 20, color: openFaq === i ? G : "#cbd5e1", transform: openFaq === i ? "rotate(180deg)" : "none", transition: "transform .25s", flexShrink: 0 }}>⌃</span>
                </button>
                <div style={{ maxHeight: openFaq === i ? 200 : 0, overflow: "hidden", transition: "max-height .3s ease" }}>
                  <p style={{ fontSize: 14.5, color: "#64748b", lineHeight: 1.72, margin: "0 0 22px", paddingRight: 28 }}>{faq.a}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <section style={{ padding: "100px 28px", backgroundColor: G, position: "relative" as const, overflow: "hidden" }}>
          <div style={{ position: "absolute" as const, inset: 0, backgroundImage: "radial-gradient(circle at 15% 50%,rgba(255,255,255,.05) 0%,transparent 55%),radial-gradient(circle at 85% 50%,rgba(255,255,255,.05) 0%,transparent 55%)", pointerEvents: "none" as const }} />
          <div style={{ maxWidth: 660, margin: "0 auto", textAlign: "center" as const, position: "relative" as const }}>
            <div className="rff">
              <div style={{ display: "inline-flex", alignItems: "center", gap: 8, backgroundColor: "rgba(255,255,255,.12)", border: "1px solid rgba(255,255,255,.15)", borderRadius: 20, padding: "6px 16px", marginBottom: 28 }}>
                <span style={{ fontSize: 14 }}>🔥</span>
                <span style={{ fontSize: 13, fontWeight: 700, color: "#fff" }}>Il reste {spots} places au prix de lancement</span>
              </div>
              <h2 style={{ fontSize: 42, fontWeight: 900, color: "#fff", letterSpacing: "-1.5px", margin: "0 0 18px", lineHeight: 1.12 }}>
              ...
              <Link href="/signup" style={{ display: "inline-flex", alignItems: "center", gap: 8, backgroundColor: "#fff", color: G, padding: "17px 42px", borderRadius: 12, fontSize: 17, fontWeight: 800, textDecoration: "none", boxShadow: "0 8px 32px rgba(0,0,0,.25)", transition: "all .15s" }}
                onMouseEnter={(e) => { e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = "0 12px 40px rgba(0,0,0,.3)"; }}
                onMouseLeave={(e) => { e.currentTarget.style.transform = ""; e.currentTarget.style.boxShadow = "0 8px 32px rgba(0,0,0,.25)"; }}
              >
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 14, marginTop: 32 }}>
                <div style={{ display: "flex" }}>
                  {[{ ini: "IK", col: "#f59e0b" },{ ini: "FD", col: "#8b5cf6" },{ ini: "MC", col: "#0891b2" }].map((av, i) => (
                    <div key={i} style={{ width: 32, height: 32, borderRadius: "50%", backgroundColor: av.col, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 11, fontWeight: 800, color: "#fff", marginLeft: i > 0 ? -8 : 0, border: "2px solid rgba(255,255,255,.25)", position: "relative" as const, zIndex: 3 - i }}>
                      {av.ini}
                    </div>
                  ))}
                </div>
          ...
          <div style={{ maxWidth: 1120, margin: "0 auto" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap" as const, gap: 24, marginBottom: 28 }}>
              <div>
                ...
                <p style={{ fontSize: 13, color: "rgba(255,255,255,.4)", margin: 0 }}>L&apos;assistant WhatsApp des restaurants maliens</p>
              </div>
            ...
            <div style={{ borderTop: "1px solid rgba(255,255,255,.07)", paddingTop: 22, textAlign: "center" as const }}>
              <p style={{ fontSize: 13, color: "rgba(255,255,255,.3)", margin: 0 }}>© 2026 RestoFlow — Fait avec ❤️ au Mali 🇲🇱</p>
            </div>
          </div>
        </footer>
